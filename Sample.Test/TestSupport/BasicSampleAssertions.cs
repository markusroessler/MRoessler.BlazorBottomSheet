...
public static class BasicSampleAssertions
{
    ...
    {
        await Assertions.Expect(BottomSheetLocators.Sheet(sheetLayout)).ToHaveCSSAsync("background-color", "rgb(238, 238, 238)");
    ...
    {
        await Assertions.Expect(BottomSheetLocators.Sheet(sheetLayout)).ToHaveCSSAsync("background-color", "rgb(15, 15, 15)");
